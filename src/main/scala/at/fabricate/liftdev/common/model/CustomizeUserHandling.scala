...
trait CustomizeUserHandling[T <: MegaProtoUser[T] with BaseEntityWithTitleAndDescription[T]] extends MetaMegaProtoUser[T]  {
  self: T =>
    ...
    // TODO: dont do hardcoding!!!
//  lazy override val validateUserPath = List("validate_user")
...
//                                              resetLink: String):
//  List[MailBodyType] = List(Mailer.xmlToMailBodyType(signupMailBody(user, resetLink)))
