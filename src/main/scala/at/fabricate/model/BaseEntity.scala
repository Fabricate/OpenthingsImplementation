...
trait BaseEntity [T <: (BaseEntity[T] with LongKeyedMapper[T]) ] extends LongKeyedMapper[T] with MatchByID[T] with CreatedUpdated
{
  self: T =>
...
trait BaseEntityMeta[ModelType <: ( BaseEntity[ModelType] with LongKeyedMapper[ModelType]) ] extends LongKeyedMetaMapper[ModelType] with CreatedUpdated
{
    self: ModelType  =>
